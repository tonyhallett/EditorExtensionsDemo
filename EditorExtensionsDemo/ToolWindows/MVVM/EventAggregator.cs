...
namespace EditorExtensionsDemo
{
    ...
    public class EventAggregator : IEventAggregator
    {
        ...
        {
            private readonly List<ListenerWrapper> _listeners = new();
        ...
        private class ListenerWrapper
        {
            ...
            private readonly List<HandleMethodWrapper> _handlers = new();
            ...
            public ListenerWrapper(object listener, Action<ListenerWrapper> onRemoveCallback, bool holdReferences, bool supportMessageInheritance)
            {
                ...
                foreach (var listenerInterface in listenerInterfaces)
                {
                    ...
                    HandleMethodWrapper handler = new(handleMethod, listenerInterface, messageType, supportMessageInheritance);
        ...
        private class HandleMethodWrapper
        {
            ...
            private readonly Dictionary<Type, bool> supportedMessageTypes = new();
